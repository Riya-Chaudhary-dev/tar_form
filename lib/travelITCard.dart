  ...
  Widget build(BuildContext context) {
    if(widget.mode=='Rental Car'){
      return Column(
        children: <Widget>[
          Divider(),
          Text('Car Rental Details',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
          SizedBox(height: 8,),
          Row(
            children: <Widget>[
              Text(
...
//                width: 170,
          ...
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                  onTap: selectDate,
                  child: Icon(Icons.calendar_today,color: Colors.deepPurple.shade200,)),
              Column(
                children: <Widget>[
                  Text(
                    'Dropoff Date: ',
      ...
      return Column(
        children: <Widget>[
          Text('In case you are using your personal car for official purpose, please fill in the details below',
            style: TextStyle(
